    ...
    if (args[0] == "box") {
      ...
      return request(encodeURI(`${threadInfo.imageSrc}`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
            ...
            var gendernu = [];
             ...
             let sex = threadInfo.approvalMode;
       var pd = sex == false ? "tắt" : sex == true ? "bật" : "Kh";
          if(!img) api.sendMessage(`🐉 Tên nhóm: ${threadInfo.threadName}\n🌳 TID: ${event.threadID}\n🏖 Phê duyệt: ${pd}\n🦖 Emoji: ${threadInfo.emoji}\n🗒 Thông tin: \n🌵 ${threadInfo.participantIDs.length} thành viên và ${threadInfo.adminIDs.length} quản trị viên.\n🗺 Gồm ${nam} nam và ${nu} nữ.\n🍭 Tổng số tin nhắn: ${threadInfo.messageCount}.`,event.threadID,event.messageID)
          else  var callback = () => api.sendMessage({body:`🍭 Tên nhóm: ${threadInfo.threadName}\n🐸 TID: ${event.threadID}\n🌴 Phê duyệt: ${pd}\n🏖 Emoji: ${threadInfo.emoji}\n⛰ Thông tin: \n🌱 ${threadInfo.participantIDs.length} thành viên và ${threadInfo.adminIDs.length} quản trị viên.\n🌵 Gồm ${nam} nam và ${nu} nữ.\n🏝 Tổng số tin nhắn: ${threadInfo.messageCount}.`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"), event.messageID);   
      return request(encodeURI(`${threadInfo.imageSrc}`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
    }
...
❎ Tuổi: 15+1
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 150🐸50
💘 Mối quan hệ: Độc thân
🌎 Quê quán: Phú thọ
👫 Gu: Ngoan hiền là được :))))
🌸 Tính cách: Thích là cáu:v
🌀 Sở thích: Chơi game, cua gái🐸, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:0567.372.394
🌐 Facebook: https://www.facebook.com/BDP2006
✉️ Email: buidangphuc206k5@hotmail.com
🏖:buidangphuc2022@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://scontent.xx.fbcdn.net/v/t1.15752-9/p480x480/243911899_423297029128173_2178703442281903708_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=ae9488&_nc_ohc=vbfavRn_wf8AX9US0a_&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=57b2a3fec9bdd506016d9f9f2f679170&oe=619625E4`)).pipe(
